...
// 🏷️ Preços server-side (em centavos p/ Blackcat) 🏷️
const PIX_PRODUCTS: Record<string, { priceCents: number; name: string }> = {
  seguro: {
    priceCents: 2863,
    name: "Seguro Prestamista - SuperSim"
  },
  up1: {
    priceCents: 2482,
  ...
  up3: {
    priceCents: 1868,
    name: "Seguro Prestamista - Tarifa de Cadastro"
  },
  up4: {
    priceCents: 1720,
    name: "TENF - Taxa de Emissão da Nota Fiscal"
  },
  up5: {
    priceCents: 1700,
    name: "Ativar Conta"
  ...
  up6: {
    priceCents: 1702,
    name: "Taxa de Registro do Contrato"
  },
  up7: {
    priceCents: 1406,
    name: "Taxa - Limite Adicional de R$20.000"
  },
  up8: {
    priceCents: 1406,
  ...
  up9: {
    priceCents: 1199,
    name: "Aplicativo SuperSim"
  },
  up10: {
    priceCents: 1692,
    name: "TAC - Taxa de Abertura de Crédito"
  },
  up11: {
    priceCents: 1953,
    name: "Taxa de Consultoria Financeira"
  },
  up12: {
    priceCents: 3192,
